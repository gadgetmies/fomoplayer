-- This should be identical to 20241220151359-remove-previews-with-null-url-from-track-details-up.sql
...
SELECT
  track_id
     ...
     , CASE
         WHEN genres.genres IS NULL
           THEN '[]' :: JSON
         ELSE genres.genres END     AS genres
