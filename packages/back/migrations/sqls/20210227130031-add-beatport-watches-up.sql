CREATE TABLE store__label_watch
(
...
CREATE TABLE store__label_watch__user
(
...
CREATE TABLE store__artist_watch
(
...
CREATE TABLE store__artist_watch__user
(
...
SELECT job_id, '*/10 * * * *'
FROM job
WHERE job_name = 'fetchBeatportWatches';
